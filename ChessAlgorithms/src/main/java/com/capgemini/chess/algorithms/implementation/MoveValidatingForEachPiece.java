...
//		int gj = to.getX();
		...
		try{
			...
			}else if(myPiece.getType() == PieceType.BISHOP || myPiece.equals("WHITE_BISHOP") == true){
				this.isThisMoveAlloved = bishopValidating(from,to);
			}else if(myPiece.equals("BLACK_QUEEN") == true || myPiece.equals("WHITE_QUEEN") == true){
				this.isThisMoveAlloved = queenValidating(from,to);
			}else if(myPiece.equals("BLACK_KING") == true || myPiece.equals("WHITE_KING") == true){
				this.isThisMoveAlloved = kingValidating(from,to);
			}else if(myPiece.equals("BLACK_ROOK") == true || myPiece.equals("WHITE_ROOK") == true){
				this.isThisMoveAlloved = rookValidating(from,to);
			}else if(myPiece.equals("BLACK_KNIGHT") == true || myPiece.equals("WHITE_KNIGHT") == true){
